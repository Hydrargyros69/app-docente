...
namespace AppDocentes.Controllers
{
    public class SedesController : Controller
    {
        ...
        public SedesController(DocentesDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdSede,Comuna,Direccion,NomSede,NomCiudad")] Sede sede)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdSede,Comuna,Direccion,NomSede,NomCiudad")] Sede sede)
        {
            if (id != sede.IdSede)
            {
                return NotFound();
