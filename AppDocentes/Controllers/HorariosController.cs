...
namespace AppDocentes.Controllers
{
    public class HorariosController : Controller
    {
        ...
        public HorariosController(DocentesDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdHorario,NomHorario")] Horario horario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdHorario,NomHorario")] Horario horario)
        {
