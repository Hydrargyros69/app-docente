...
namespace AppDocentes.Controllers
{
    public class DocentesController : Controller
    {
        ...
        {
            var docentesDbContext = _context.Docentes.Include(d => d.IdCategoriaNavigation);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDocente,IdCategoria,Telefono,NomDocente,Rut,PatDocente,MatDocente,EstadoCivil,FechaNacimiento,Nacionalidad,Direccion,Correo")] Docente docente)
        {
